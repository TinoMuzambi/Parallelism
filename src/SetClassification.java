...
public class SetClassification extends RecursiveAction {
    ...
    /**
     * Assign classifications using fork-join.
     */
    @Override
    protected void compute() {
        if ((hi - lo) < ParallelVersion.SEQ_CUTOFF) {
            ...
            SetClassification left = new SetClassification(cloudData, lo, (hi + lo) / 2, averages);
            SetClassification right = new SetClassification(cloudData, (hi + lo) / 2, hi, averages);
